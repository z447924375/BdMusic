...
import zxh.bdmusic.main.SendChangeMessage;
...
public class RecommendFragment extends BaseFragment {
    SendChangeMessage changeMessage;
                    ...
                    public void CallBack(int PosValues) {
                        switch (PosValues) {
                            ...
                            case 1:
                                ...
                                break;
                            case 2:
//                                fm.beginTransaction().hide(recommendFragment).add(R.id.main_frame_ll, new McClassifyFragment()).commit();
                                break;
                            case 3:
                                //radio
                                break;
